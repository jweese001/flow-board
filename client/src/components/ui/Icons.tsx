...
export function Loader2Icon({ size = 24, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PanelLeftIcon({ size = 24, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LayoutIcon({ size = 24, className = '', style }: IconProps & { style?: React.CSSProperties }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TransformIcon({ size = 24, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FlipHorizontalIcon({ size = 24, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FlipVerticalIcon({ size = 24, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ApertureIcon({ size = 24, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SaveAsIcon({ size = 24, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SkipBackIcon({ size = 24, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
